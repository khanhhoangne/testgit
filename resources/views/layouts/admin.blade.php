...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#adminaccount-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-people"></i><span>Tài khoản quản trị</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="adminaccount-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="">
        ...
        <ul id="categories-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('admin.categories')}}">
              <i class="bi bi-circle"></i><span>Tất cả danh mục</span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#suppliers-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Thương hiệu</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="suppliers-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('admin.suppliers')}}">
              <i class="bi bi-circle"></i><span>Tất cả Thương hiệu</span>
            </a>
          </li>
          <li>
            <a href="{{route('admin.addsupplier')}}">
              <i class="bi bi-circle"></i><span>Thêm mới Thương hiệu</span>
            </a>
          </li>
        </ul>
      </li><!-- End Supplier Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Quản lý Slider</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Công ty TNHH Kinh doanh và Buôn bán <strong><span>TechDiz</span></strong>
    </div>
    <div class="credits">
      ...
      Thông tin chi tiết <a href="https://techdiz.com/">TechDiz</a>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="{{ asset('assets/js/my_alert.js') }}"></script>
  @livewireScripts
